...
- تحديد المدة بدقة (١٥/٣٠/٦٠ ثانية ≈ ٤٠/٨٠/١٦٠ كلمة) والقناة والنبرة.`,
  },
  {
    ...
    name: "مشروع متكامل",
    icon: "🎬",
    desc: "سلسلة برومبتات متناسقة لمشروع كامل",
    platforms: ["ChatGPT / Claude / Gemini"],
    primaryLang: "ar",
    expertise: `قواعد برومبت المشروع المتكامل (سلسلة إنتاج):
- فكّك المشروع لمكوناته: سيناريو/نص ← لقطات فيديو أو صور ← موسيقى/صوت ← غلاف.
- اكتب برومبتاً منفصلاً مكتمل الحرفة لكل مكوّن تحت عنوان واضح (## المكوّن)، بلغة منصته الأصلح (الصور والفيديو والموسيقى بالإنجليزية).
- الاتساق قانون: نفس الشخصيات والمكان والحقبة ولوحة الألوان والمزاج تسري في كل المكونات حرفياً.
- ابدأ بفقرة «الرؤية الموحدة» التي تضبط الهوية البصرية والسمعية، وتُقتبس داخل كل برومبت فرعي.`,
  },
  {
    id: "voiceover",
    name: "تعليق صوتي",
