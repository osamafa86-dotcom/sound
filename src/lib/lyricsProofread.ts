...
٣. **تلقين الأداء الغنائي**: سكّن نهايات الأسطر سكونَ وقفٍ غنائي (القافية تُقفل بسكون لا بإعراب) إلا إذا كانت القافية ممدودة فأثبت مدّها بحركتها الطويلة؛ **الشدّة تُكتب صريحة دائماً مع حركتها** (لا شدّة عارية)؛ التنوين لا يُغنّى في العامية — استبدله بحركة أو سكون وقف حسب اللهجة؛ وهمزة الوصل تُحرَّك كما تُنطق في سياقها المغنّى.
