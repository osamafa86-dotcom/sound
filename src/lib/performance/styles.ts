...
export const PERFORMANCE_STYLES: PerformanceStyle[] = [
  ...
  },
  {
    ...
    name: "تأمل هادئ (ASMR)",
    icon: "🧘",
    desc: "همس ناعم مسترخٍ للتأمل والاسترخاء — لا للأسرار الدرامية (تلك في «همس الأسرار»)",
    category: "سرد",
    tags: ["whispers", "soft calm relaxing ASMR-like delivery"],
    stability: 0,
  },
  {
    id: "devotional",
  ...
  // («الخوف والتوتر» يغطيه مشهد «الرعب المطلق»، و«الأمل الملهم» يغطيه
  //  «خطاب تحفيزي» — حُذفا منعاً للتكرار في اللوحة)
